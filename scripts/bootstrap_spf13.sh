...
create_symlinks() {
    ...
    #FIXME, resolve all persistent config/links by dotfiles
    #NOT NEEDED ANY MORE - LINKS ARE SET BY HOMESHICK.
    echo lnif "$source_path/.vimrc"         "$target_path/.vimrc"
    echo lnif "$source_path/.vimrc.bundles" "$target_path/.vimrc.bundles"
    echo lnif "$source_path/.vimrc.before"  "$target_path/.vimrc.before"
    echo lnif "$source_path/.vim"           "$target_path/.vim"

    if program_exists "nvim"; then
        echo lnif "$source_path/.vim"       "$target_path/.config/nvim"
        echo lnif "$source_path/.vimrc"     "$target_path/.config/nvim/init.vim"
    fi
